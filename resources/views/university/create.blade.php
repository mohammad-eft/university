...
<head>
    ...
    <title>ثبت دانشگاه</title>
</head>
<body>
    @include('header')
    <h1 class="text-center text-3xl font-bold text-gray-700 my-10">ثبت دانشگاه</h1>
    ...
    <form action="{{ route('uni.store') }}" method="post" class="w-1/2 m-auto border rounded-lg p-5">
        @csrf
        <div class="mb-10">
            <label for="name" class="text-lg font-normal text-gray-700 mb-3 inline-block">نام دانشگاه :</label>
            <input type="text" name="name" id="name" class="w-full outline-none border rounded-md px-10 py-3" placeholder="نام دانشگاه را وارد کنید">
        </div>
        <div class="mb-10">
            <label for="city" class="text-lg font-normal text-gray-700 mb-3 inline-block">نام شهر :</label>
            <input type="text" name="city" id="city" class="w-full outline-none border rounded-md px-10 py-3" placeholder="نام شهر را وارد کنید">
        </div>
